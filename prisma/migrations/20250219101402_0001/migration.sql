...
CREATE TABLE "User" (
    ...
    "avatarUrl" TEXT DEFAULT 'https://mindsrcibe.s3.amazonaws.com/defaultBanner.jpg',
    "facebookLink" TEXT,
    "instagramLink" TEXT,
    "xLink" TEXT,
    "twitchLink" TEXT,
...
CREATE TABLE "Post" (
    ...
    "bannerUrl" TEXT NOT NULL DEFAULT 'https://mindsrcibe.s3.amazonaws.com/defaultBanner.jpg',
    "title" TEXT NOT NULL,
